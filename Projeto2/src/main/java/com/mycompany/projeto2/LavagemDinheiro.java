...
public class LavagemDinheiro extends Negocio implements Policiavel {
    ...
    //Obtem média da Inteligência da equipa de Soldiers e consoante esse valor é atribuido novos valores para a rentabilidade, Valor base tributavel e probabilidade da policia atuar
    @Override
